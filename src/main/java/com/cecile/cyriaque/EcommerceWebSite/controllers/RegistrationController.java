...
import com.cecile.cyriaque.EcommerceWebSite.service.UserService;
...
public class RegistrationController {
    ...
    @PostMapping
    public String userRegistration(final @Valid UserRegistration userRegistration, final BindingResult bindingResult, final Model model) {
